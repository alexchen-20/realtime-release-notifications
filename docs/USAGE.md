...
The single thin client is the seam: add a method that calls another `/v1/...` route (e.g. one of realtime.channel.create, realtime.publish) and reuse it from your own code.
